...
(
  id SERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  country INT REFERENCES countries ON DELETE CASCADE
);
...
(
  ...
  airline INT REFERENCES airlines ON DELETE SET NULL,
  from_city INT REFERENCES cities ON DELETE SET NULL,
  to_city INT REFERENCES cities ON DELETE SET NULL
);
